        ...
        <div className="bg-white">
            <div className="py-16 sm:py-24 xl:mx-auto xl:max-w-7xl xl:px-8">
                <div className="px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 xl:px-0">
                    <h2 className="text-2xl font-bold tracking-tight text-gray-900">{get(category, "nombre")}</h2>
                                ...
                                {map(slice(get(category, "products", []), 0, 5), (product) => (
                                    ...
                                    >
                                        <span aria-hidden="true" className="absolute inset-0">
                                            <img alt="" src={get(product, "imageSrc")} className="h-full w-full object-cover object-center" />
                                        </span>
                                        <span
                                            aria-hidden="true"
                                            className="absolute inset-x-0 bottom-0 h-2/3 bg-gradient-to-t from-gray-800 opacity-50"
                                        />
                                        <span className="relative mt-auto text-center text-xl font-bold text-white">{get(product, "name")}</span>
                                    </Link>
                                ))}
                            </div>
                        </div>
