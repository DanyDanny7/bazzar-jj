const navigation = {
    ...
    social: [
...

        {
            ...
            name: 'TikTok',
            href: 'https://www.tiktok.com/@bazarfashionjj?_t=8rZK2MYqlsd&_r=1',
            icon: (props) => (
        ...
        {
            name: 'Instagram',
            href: 'https://www.instagram.com/bazar_fashionjj20?igsh=YzljYTk1ODg3Zg==',
            icon: (props) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <path
                        fillRule="evenodd"
            ...
            <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
                ...
                <div className="mt-16 flex justify-center gap-x-10">
                    {navigation.social.map((item) => (
                        <a key={item.name} href={item.href} target="blank" className="text-gray-600 hover:text-gray-800" {...item.action ? { "data-action": "share/whatsapp/share" } : {}}>
