const navigation = {
    ...
    social: [
...

        {
             ...
             name: 'TikTok',
             href: 'https://www.tiktok.com/cfmotosv',
             icon: (props) => (
       ...
       {
                name: 'Instagram',
             href: 'https://www.instagram.com/sabordelmundo',
                icon: (props) => (
                    <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                        <path
                            fillRule="evenodd"
        ...
        {
            name: 'WhatsApp',
            href: `http://wa.me/+50371368285?text=${encodeURIComponent('Bienvenidos al whatsapp de Bazar Fashion JJ ¿En que podemos ayudarle?')}`, // Replace 'Your custom message here' with your desired pre-filled message
            icon: (props) => (
