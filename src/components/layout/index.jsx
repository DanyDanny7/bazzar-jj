...
const navigation = [
  ...
  { name: 'Moda', href: '/moda', current: false },
  { name: 'Tendencia', href: '/tendencia', current: false },
  { name: 'Dama', href: '/dama', current: false },
  { name: 'Caballero', href: '/caballero', current: false },
]
